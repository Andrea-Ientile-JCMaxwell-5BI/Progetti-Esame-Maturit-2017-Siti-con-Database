...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT alunni.* FROM gestiscono, professori, alunni WHERE gestiscono.id_professore = professori.id_professore AND gestiscono.id_alunno = alunni.id_alunno AND professori.username ='$username' AND alunni.cognome LIKE '%".$valore_da_cercare."%'";
    $search_result = filterTable($query);

}
 else {
   $query = "SELECT alunni.* FROM gestiscono, professori, alunni WHERE gestiscono.id_professore = professori.id_professore AND gestiscono.id_alunno = alunni.id_alunno  AND professori.username ='$username';";
   $search_result = filterTable($query);
}
